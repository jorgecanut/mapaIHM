...
namespace {
struct qt_meta_tag_ZN13LoginRegisterE_t {};
} // unnamed namespace

template <> constexpr inline auto LoginRegister::qt_create_metaobjectdata<qt_meta_tag_ZN13LoginRegisterE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<LoginRegister, qt_meta_tag_ZN13LoginRegisterE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject LoginRegister::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13LoginRegisterE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13LoginRegisterE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13LoginRegisterE_t>.metaTypes,
    nullptr
} };
...
void *LoginRegister::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13LoginRegisterE_t>.strings))
